    ...
    <div class="flex flex-col justify-between h-full">
        <div class="flex-grow">
            ...
            <div class="p-4">
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('dashboard') }}" class="flex items-center rounded-xl font-bold text-sm py-3 px-4
                    ...
                    <li>
                        <a href="{{ route('dashboardIndexDate') }}" class="flex rounded-xl font-bold text-sm py-3 px-4
